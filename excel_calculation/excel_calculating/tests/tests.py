...
class ExcelCalculationTests(APITestCase):
    test_file_path = Path(settings.BASE_DIR, "excel_calculating/tests/static/test_data.xlsx")
    ...
    def test_upload_excel_and_columns(self):
        ...
        response = self.client.post(
            "/excel_calculating/excel-calculating/",
            data,
            format="multipart"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["summary"][0], {
            "column": "current usd",
            "sheet_column": "E",
    ...
    def test_upload_excel_and_columns_fails_on_wrong_column_name(self):
        ...
        self.assertEqual(response.data["detail"], "Columns with names {'tests'} do not exist in given excel file")
    ...
    def test_upload_excel_and_columns_fails_on_wrong_column_data(self):
        ...
        self.assertEqual(response.data["detail"], "Cannot calculate data for column description with given excel file")
